...
HD_PWD='C:/Users/yashp/OneDrive/Documents/riscv_verification/single_stage_processor/single_stage_procesor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_COMPLETE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV_COMPLETE.tcl -notrace
